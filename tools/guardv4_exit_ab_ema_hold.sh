...
HOST_OV="user_data/overrides/exit_ema_hold30.json"
OV_HOLD30="/freqtrade/user_data/overrides/exit_ema_hold30.json"
cat > "$HOST_OV" <<'JSON'
{
  "strategy_parameters": {
    "ema_exit_min_hold_min": 30
  }
}
JSON
...
with zipfile.ZipFile(zip_path) as z:
    ...
    print("ZIP_CFG: ema_exit_min_hold_min =", sp.get("ema_exit_min_hold_min","<missing>"))
    trades=None
...
run_one(){
  ...
  local log="${OUTDIR}/bt_emaAB_${TIMERANGE}_${STRATEGY}_${label}_${TS}.log"
