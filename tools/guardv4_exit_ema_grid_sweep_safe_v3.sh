...
CSV="$OUTDIR/_exit_ema_grid_v3_${TIMERANGE}_${TS}.csv"
...
run_case() {
  ...
  local log="${OUTDIR}/bt_exitEmaGridV3_${TIMERANGE}_${STRATEGY}_${tag}_${TS}.log"
...
echo "START: exit_fast/slow EMA grid sweep V3 | STRATEGY=$STRATEGY TIMERANGE=$TIMERANGE"
